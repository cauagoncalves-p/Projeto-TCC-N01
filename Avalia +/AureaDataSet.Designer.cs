...
namespace Avalia__ {
    ...
    public partial class AureaDataSet : global::System.Data.DataSet {
        ...
        public partial class tbUsuarioDataTable : global::System.Data.TypedTableBase<tbUsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbUsuarioRow AddtbUsuarioRow(string Nome, string Sobrenome, System.DateTime Data_Nascimento, string CPF, string Sexo, string Telefone, string Genero, string Endereco, string Email, string Cidade, string Estado, System.DateTime Data_Cadastro) {
...
namespace Avalia__.AureaDataSetTableAdapters {
    ...
    public partial class tbUsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbUsuario] ([Nome], [Sobrenome], [Data_Nascimento], [CPF], [Sexo], [Telefone], [Genero], [Endereco], [Email], [Cidade], [Estado], [Data_Cadastro]) VALUES (@Nome, @Sobrenome, @Data_Nascimento, @CPF, @Sexo, @Telefone, @Genero, @Endereco, @Email, @Cidade, @Estado, @Data_Cadastro);
SELECT Id_usuario, Nome, Sobrenome, Data_Nascimento, CPF, Sexo, Telefone, Genero, Endereco, Email, Cidade, Estado, Data_Cadastro FROM tbUsuario WHERE (Id_usuario = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbUsuario] SET [Nome] = @Nome, [Sobrenome] = @Sobrenome, [Data_Nascimento] = @Data_Nascimento, [CPF] = @CPF, [Sexo] = @Sexo, [Telefone] = @Telefone, [Genero] = @Genero, [Endereco] = @Endereco, [Email] = @Email, [Cidade] = @Cidade, [Estado] = @Estado, [Data_Cadastro] = @Data_Cadastro WHERE (([Id_usuario] = @Original_Id_usuario) AND ([Nome] = @Original_Nome) AND ([Sobrenome] = @Original_Sobrenome) AND ([Data_Nascimento] = @Original_Data_Nascimento) AND ([CPF] = @Original_CPF) AND ([Sexo] = @Original_Sexo) AND ([Telefone] = @Original_Telefone) AND ([Genero] = @Original_Genero) AND ([Endereco] = @Original_Endereco) AND ([Email] = @Original_Email) AND ([Cidade] = @Original_Cidade) AND ([Estado] = @Original_Estado) AND ([Data_Cadastro] = @Original_Data_Cadastro));
SELECT Id_usuario, Nome, Sobrenome, Data_Nascimento, CPF, Sexo, Telefone, Genero, Endereco, Email, Cidade, Estado, Data_Cadastro FROM tbUsuario WHERE (Id_usuario = @Id_usuario)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_usuario, Nome, Sobrenome, Data_Nascimento, CPF, Sexo, Telefone, Genero," +
                " Endereco, Email, Cidade, Estado, Data_Cadastro FROM dbo.tbUsuario";
        ...
        public virtual int Insert(string Nome, string Sobrenome, System.DateTime Data_Nascimento, string CPF, string Sexo, string Telefone, string Genero, string Endereco, string Email, string Cidade, string Estado, System.DateTime Data_Cadastro) {
            if ((Nome == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[24].Value = ((System.DateTime)(Original_Data_Cadastro));
            this.Adapter.UpdateCommand.Parameters[25].Value = ((int)(Id_usuario));
        ...
        public virtual int Update(
                    ...
                    string Original_Estado, 
                    System.DateTime Original_Data_Cadastro) {
            return this.Update(Nome, Sobrenome, Data_Nascimento, CPF, Sexo, Telefone, Genero, Endereco, Email, Cidade, Estado, Data_Cadastro, Original_Id_usuario, Original_Nome, Original_Sobrenome, Original_Data_Nascimento, Original_CPF, Original_Sexo, Original_Telefone, Original_Genero, Original_Endereco, Original_Email, Original_Cidade, Original_Estado, Original_Data_Cadastro, Original_Id_usuario);
        }
    }
